...
Zajímavé je, že Netflix sám odhalil, že 80 % toho, co lidé sledují, pochází z doporučení — ne z vlastního vyhledávání. To znamená, že bez algoritmu bys skončil u sledování stále stejných věcí, které znáš, a obrovská část knihovny by pro tebe prakticky neexistovala.

Čím více platforem vzniká, tím důležitější doporučovací systémy jsou. Spotify má přes 100 milionů skladeb — kdybys poslouchal jednu za minutou, trvalo by ti projít celý katalog 190 let. Algoritmus je jediný způsob, jak se v takovém množství obsahu vůbec orientovat.
