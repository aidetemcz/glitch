...
? Jak přesné jsou doporučení nejlepších systémů jako Netflix?
- Skoro dokonalé — mýlí se v méně než 5 % případů
- Doporučení jsou přesná jen tehdy, když má systém dost dat o uživateli
- Záleží na obsahu — u filmů jsou přesná, u seriálů méně
* Mýlí se asi ve 20–30 % případů — dokonalost není cíl, záleží na tom, aby byl správně ve většině případů
! Přesně! 20–30 % chybovost je u nejlepších systémů normální.
