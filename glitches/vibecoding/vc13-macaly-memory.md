...
Normální AI si nepamatuje nic z minulé konverzace — každý nový chat začínáš od nuly. Agent Memory v Macaly si ukládá strukturu projektu, tvoje preference i rozhodnutí.

Praktický dopad: příští den pokračuješ tam, kde jsi skončil. Prostě napíšeš „přidej sdílení" — a AI ví, o jaké aplikaci mluví.
